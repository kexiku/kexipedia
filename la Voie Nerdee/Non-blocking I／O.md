[Node JS](https://www.educative.io/answers/introduction-to-node-js) is a popular server-side JavaScript runtime environment with an event-driven, non-blocking I/O model.
